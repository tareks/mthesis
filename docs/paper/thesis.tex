...
%% Formatting according to https://www.it.uu.se/edu/exjobb/master/rapporten
...
%\begin{center}In fond memory of 25 January 2011 and 30 June 2012.
%\setcode{utf8}
...
matched with as this is purely ad-hoc, based on a first-come-first-serve basis. The uniqueness of the \texttt{<gameid>}
 ...
 play Tic-Tac-Toe passively listen for Interests with a prefix of \texttt{\seqsplit{ccnx://uu/core/games/ttt/new}}. These nodes are referred to as \emph{Host} nodes. The \verb!<gameid>! portion of the URI is parsed and used to label and a new game instance, which is
